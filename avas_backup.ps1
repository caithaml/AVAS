...
#jsondef je nastaven na pevnou cestu!!! nutno změnit při změně PC!!!! nebo nastavit open file dialog pro druhý soubor
...
$hash | Add-Member Noteproperty Computerturen_root_certifikates ($json.Computer_Root_Certificates) #duplikace s výpisem certifikátů -> jejihc porovnání viz. výše
