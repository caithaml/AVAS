...
$mlbl_vrtiaulfree                    = New-Object -TypeName System.Windows.Forms.Label 
$mlbl_vrtiaulfree.Text       = 'Virtual free' 
$mlbl_vrtiaulfree.Top        = '615' 
$mlbl_vrtiaulfree.Left       = '10' 
$mlbl_vrtiaulfree.Anchor     = 'Left,Top' 
$mlbl_vrtiaulfree.Size               = New-Object -TypeName System.Drawing.Size -ArgumentList (100, 23) 
...
$mbtn_tisk.Add_Click({
    ...
    $json.Services |
    ConvertTo-Html -Head $a -Body '<H2>Test tisku formulare</H2>' | 
    Out-File -FilePath C:\SICZ\Testtisk.html
})
...
$mbtn_patchlevel.Add_Click({
    Start-Process -FilePath powershell.exe -ArgumentList 'D:\SICZ\avas\avas_luka\patche.ps1'
})
...
$mbtn_nacistjson.Add_Click({
    Start-Process -FilePath powershell.exe -ArgumentList 'D:\SICZ\avas\avas_luka\openfiledialog.ps1'
})
