...
#jsondef je nastaven na pevnou cestu!!! nutno zm�nit p�i zm�n� PC!!!! nebo nastavit open file dialog pro druh� soubor
...
$hash | Add-Member Noteproperty Computerturen_root_certifikates ($json.Computer_Root_Certificates) #duplikace s v�pisem certifik�t� -> jejihc porovn�n� viz. v��e
